...
Mở wave N. Đọc MATRIX, sinh `agents/dev-{prefix-boundary}-agent.md`, `agents/fix-{prefix-boundary}-agent.md`, `knowledge-base/{boundary}.knowledge-graph.yaml` cho mỗi boundary trong wave.
